...
SeekHead::Entry::Entry() :
		id(0), pos(0), element_start(0), element_size(0) {}
...
long long VideoTrack::GetAlphaMode() const {
	return m_alpha_mode;
}
...
const BlockAdditions *BlockGroup::GetBlockAdditions() const {
	return &m_block_additions;
}
...
long long BlockAdditions::GetAddID() const {
	return m_add_id;
}

long BlockAdditions::GetBufferSize() const {
	return m_buffer_size;
}

bool BlockAdditions::IsValid() const {
	return m_valid;
}
